...
module.exports = {
    ...
    async execute(interaction) {
        try {
            ...
            if (!verifiedRole) {
                return interaction.editReply('Verified role not found in this server.');
            }
            ...
            if (otherRoles.size > 0) {
                ...
                await interaction.editReply({ content: `${targetUser.username} only has the Verified role. Do you want to send a message?`, components: [row] });
            ...
            console.error('Error executing checkrole:', error);
